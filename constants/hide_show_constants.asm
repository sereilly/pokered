...
; and are detected in wMissableObjectList)
	...
	const HS_STARTER_BALL_CINNABAR_1       ; E4
	const HS_STARTER_BALL_CINNABAR_2       ; E5
	const HS_STARTER_BALL_CINNABAR_3       ; E6
	const HS_STARTER_BALL_PEWTER_1         ; E4
	const HS_STARTER_BALL_PEWTER_2         ; E5
	const HS_STARTER_BALL_PEWTER_3         ; E6
	const HS_STARTER_BALL_VIRIDIAN_1       ; E7
	const HS_STARTER_BALL_VIRIDIAN_2       ; E8
	const HS_STARTER_BALL_VIRIDIAN_3       ; E9
	const HS_STARTER_BALL_CERULEAN_1       ; EA
	const HS_STARTER_BALL_CERULEAN_2       ; EB
	const HS_STARTER_BALL_CERULEAN_3       ; EC
	const HS_STARTER_BALL_VERMILION_1      ; ED
	const HS_STARTER_BALL_VERMILION_2      ; EE
	const HS_STARTER_BALL_VERMILION_3      ; EF
	const HS_STARTER_BALL_CELADON_1       ; F0
	const HS_STARTER_BALL_CELADON_2       ; F1
	const HS_STARTER_BALL_CELADON_3       ; F2
	const HS_STARTER_BALL_FUCHSIA_1       ; F3
	const HS_STARTER_BALL_FUCHSIA_2       ; F4
	const HS_STARTER_BALL_FUCHSIA_3       ; F5
	const HS_STARTER_BALL_LAVENDER_1     ; F6
	const HS_STARTER_BALL_LAVENDER_2     ; F7
	const HS_STARTER_BALL_LAVENDER_3     ; F8
	const HS_STARTER_BALL_SAFFRON_1     ; F9
	const HS_STARTER_BALL_SAFFRON_2     ; FA
	const HS_STARTER_BALL_SAFFRON_3     ; FB
