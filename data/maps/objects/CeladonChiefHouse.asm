	...
	const_export CELADONCHIEFHOUSE_BELLSPROUT_POKE_BALL
	const_export CELADONCHIEFHOUSE_VULPIX_POKE_BALL
	const_export CELADONCHIEFHOUSE_PORYGON_POKE_BALL
...
CeladonChiefHouse_Object:
	...
	object_event  3,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_CELADONCHIEFHOUSE_BELLSPROUT_POKE_BALL
	object_event  4,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_CELADONCHIEFHOUSE_VULPIX_POKE_BALL
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_CELADONCHIEFHOUSE_PORYGON_POKE_BALL
