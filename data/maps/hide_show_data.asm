...
; entries correspond to map ids
	...
	dw MrFujisHouseHS
	dw NoHS
	dw LavenderCuboneHouseHS
	dw NoHS
	dw FuchsiaBillsGrandpasHouseHS
	dw NoHS
	dw WardensHouseHS
	dw NoHS
	dw NoHS
...
PalletTownHS:
	...
	db PALLET_TOWN, PALLETTOWN_SEEL, HIDE
ViridianCityHS:
...
CinnabarLabTradeRoomHS:
	db CINNABAR_LAB_TRADE_ROOM, CINNABARLABTRADEROOM_CHARMANDER_POKE_BALL, SHOW
	db CINNABAR_LAB_TRADE_ROOM, CINNABARLABTRADEROOM_SQUIRTLE_POKE_BALL, SHOW
	db CINNABAR_LAB_TRADE_ROOM, CINNABARLABTRADEROOM_BULBASAUR_POKE_BALL, SHOW
PewterNidoranHouseHS:
	db PEWTER_NIDORAN_HOUSE, PEWTERNIDORANHOUSE_GEODUDE_POKE_BALL, SHOW
	db PEWTER_NIDORAN_HOUSE, PEWTERNIDORANHOUSE_NIDORANF_POKE_BALL, SHOW
	db PEWTER_NIDORAN_HOUSE, PEWTERNIDORANHOUSE_ODDISH_POKE_BALL, SHOW
ViridianSchoolHouseHS:
	db VIRIDIAN_SCHOOL_HOUSE, VIRIDIANSCHOOLHOUSE_CATERPIE_POKE_BALL, SHOW
	db VIRIDIAN_SCHOOL_HOUSE, VIRIDIANSCHOOLHOUSE_NIDORANM_POKE_BALL, SHOW
	db VIRIDIAN_SCHOOL_HOUSE, VIRIDIANSCHOOLHOUSE_MANKEY_POKE_BALL, SHOW
CeruleanTradeHouseHS:
	db CERULEAN_TRADE_HOUSE, CERULEANTRADEHOUSE_POLIWAG_POKE_BALL, SHOW
	db CERULEAN_TRADE_HOUSE, CERULEANTRADEHOUSE_ABRA_POKE_BALL, SHOW
	db CERULEAN_TRADE_HOUSE, CERULEANTRADEHOUSE_MEOWTH_POKE_BALL, SHOW
VermilionTradeHouseHS:
	db VERMILION_TRADE_HOUSE, VERMILIONTRADEHOUSE_PIKACHU_POKE_BALL, SHOW
	db VERMILION_TRADE_HOUSE, VERMILIONTRADEHOUSE_MACHOP_POKE_BALL, SHOW
	db VERMILION_TRADE_HOUSE, VERMILIONTRADEHOUSE_DIGLETT_POKE_BALL, SHOW
CeladonChiefHouseHS:
	db CELADON_CHIEF_HOUSE, CELADONCHIEFHOUSE_BELLSPROUT_POKE_BALL, SHOW
	db CELADON_CHIEF_HOUSE, CELADONCHIEFHOUSE_VULPIX_POKE_BALL, SHOW
	db CELADON_CHIEF_HOUSE, CELADONCHIEFHOUSE_PORYGON_POKE_BALL, SHOW
FuchsiaBillsGrandpasHouseHS:
	db FUCHSIA_BILLS_GRANDPAS_HOUSE, FUCHSIABILLSGRANDPASHOUSE_KOFFING_POKE_BALL, SHOW
	db FUCHSIA_BILLS_GRANDPAS_HOUSE, FUCHSIABILLSGRANDPASHOUSE_DODUO_POKE_BALL, SHOW
	db FUCHSIA_BILLS_GRANDPAS_HOUSE, FUCHSIABILLSGRANDPASHOUSE_SLOWPOKE_POKE_BALL, SHOW
LavenderCuboneHouseHS:
	db LAVENDER_CUBONE_HOUSE, LAVENDERCUBONEHOUSE_GASTLY_POKE_BALL, SHOW
	db LAVENDER_CUBONE_HOUSE, LAVENDERCUBONEHOUSE_CUBONE_POKE_BALL, SHOW
	db LAVENDER_CUBONE_HOUSE, LAVENDERCUBONEHOUSE_CLEFAIRY_POKE_BALL, SHOW
CopycatsHouse1FHS:
	db COPYCATS_HOUSE_1F, COPYCATSHOUSE1F_ABRA_POKE_BALL, SHOW
	db COPYCATS_HOUSE_1F, COPYCATSHOUSE1F_EEVEE_POKE_BALL, SHOW
	db COPYCATS_HOUSE_1F, COPYCATSHOUSE1F_DITTO_POKE_BALL, SHOW
